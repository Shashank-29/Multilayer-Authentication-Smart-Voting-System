...
import sys
sys.path.insert(0, 'C:/Users/shash/Desktop/5th sem/face-attendance-system-master3/Silent-Face-Anti-Spoofing')
import test
...
class App:
    ...
    def login(self):
        ...
        label = test(
                ...
                model_dir=r'C:\Users\shash\Desktop\5th sem\face-attendance-system-master3\Silent-Face-Anti-Spoofing\resources\anti_spoof_models',
                device_id=0
                )
